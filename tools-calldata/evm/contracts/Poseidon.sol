...
contract Poseidon {
    ...
    function hashmultiple(uint256[2] calldata input, uint times) external pure returns (uint256 result) {
           uint i = 0;
        uint256 tmp;
        for (i = 0; i < times; i += 1) {
            tmp = hash(input);
...
// identity
// 2ff267fd23782a5625e6d804f0a7fa700b8dc6084e2e7a5aff7cd4b1c506d30b;;